...
const char *const ua_pack[LABEL_NUM]={
  UA_LANGUAGE,
  UA_HEAT,
  UA_MOVE,
  UA_HOME,
  ...
  UA_TFTSD_REMOVED,
  UA_U_DISK,
  UA_READ_U_DISK_ERROR,
  UA_U_DISK_INSERTED,
  UA_U_DISK_REMOVED,
  UA_ONBOARDSD,
  UA_READ_ONBOARDSD_ERROR,
  UA_FILAMENT_RUNOUT,
  UA_PREHEAT,
  UA_PREHEAT_BOTH,
  UA_PREHEAT_PLA,
...
{  
  switch(infoSettings.language)
  {
    ...
    case UKRAINE:     return (u8 *)ua_pack[sel];
